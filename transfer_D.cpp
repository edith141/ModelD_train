...
int main(int argc, char** argv)
{
    ...
    trainer.be_verbose();
    trainer.set_synchronization_file("face_metric_sync_trans", std::chrono::minutes(5));
    ...
    dlibnet.clean();
    serialize("metric_network_renset_Dtrans.dat") << dlibnet;
